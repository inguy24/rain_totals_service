...
GITHUB_URL = "https://github.com/inguy24/rain_totals_service/"
...
class RainTotalsInstaller(object):
    ...
    def install(self, engine):
        ...
        # Check Python version (f-strings require Python 3.6+)
        if sys.version_info < (3, 6):
            print("ERROR: Rain Totals requires Python 3.6 or later for f-string support")
        ...
        print(f"Author: {AUTHOR} - {GITHUB_URL}")
